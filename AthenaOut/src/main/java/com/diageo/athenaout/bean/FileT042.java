...
//                + "      CASE "
//                + "        WHEN CI.NAME_TOWN = 'BOGOTA, D.C.' THEN 'BOGOTA D.C.' "
//                + "        ELSE CI.NAME_TOWN "
//                + "      END AS desLoc_1,  "
...
//                + "  CHAN.ADDRESS, "
//                + "  CASE "
//                + "        WHEN TOWN.NAME_TOWN = 'BOGOTA, D.C.' THEN 'BOGOTA D.C.' "
//                + "        ELSE TOWN.NAME_TOWN "
...
//                + " WHERE CHAN.IS_ACTIVE = 1";
        String sql = "SELECT  "
                ...
                + " LEFT JOIN DB_3PARTY_REGIONAL RE ON RE.DB_3PARTY_REGIONAL_ID = PA.DB_3PARTY_REGIONAL_ID                          "
                + " WHERE CHAN.IS_ACTIVE = 1 "
                + "AND (TO_DATE(CHAN.MODIFICATION_DATE,'DD-MM-YYYY') > TO_DATE('15-11-16','DD-MM-YYYY') "
                + "OR TO_DATE(CHAN.CREATION_DATE,'DD-MM-YYYY') = TO_DATE('21-11-16','DD-MM-YYYY'))";
