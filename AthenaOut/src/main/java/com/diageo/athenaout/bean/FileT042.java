...
public class FileT042 {
    ...
    public List<T042PartyAddrDto> findOutlets() {
        ...
        String sql = "SELECT o.OUTLET_ID AS codParty,o.ADDRESS AS desAddre_1,ci.NAME_TOWN AS desLoc_1, "
                ...
                + "WHERE o.IS_FATHER='1' "
                + "UNION ALL "
                + "SELECT CHAN.CHAIN_ID,CHAN.ADDRESS,TOWN.DISTRI_1, "
                + "PHO.NUMBER_PHONE,DE.DISTRI_1,RE.DISTRI_1,'CO' AS NATION,NULL AS EMAIL,NULL AS WEBSITE "
                + "FROM DB_CHAINS CHAN "
                + "LEFT JOIN DB_TOWNS TOWN ON TOWN.TOWN_ID=CHAN.TOWN_ID "
                + "LEFT JOIN DB_CHAINS_PHONES DCP ON DCP.CHAIN_ID=CHAN.CHAIN_ID "
                + "LEFT JOIN DB_PHONES PHO ON PHO.PHONE_ID=DCP.PHONE_ID "
...
//                + "  pho.NUMBER_PHONE AS numPhone_1, "
//                + "  de.DISTRI_1 AS codArea, "
//                + "  pr.NAME_REGIONAL AS codZone, "
