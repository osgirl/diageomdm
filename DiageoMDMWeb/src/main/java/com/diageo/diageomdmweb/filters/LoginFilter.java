...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
           if (((HttpServletRequest) request).getRequestURI().endsWith(".js.jsf")
                || ((HttpServletRequest) request).getRequestURI().endsWith(".css.jsf")) {
            chain.doFilter(request, response);
        } else {
            HttpServletResponse responses = (HttpServletResponse) response;
            responses.setHeader("X-UA-Compatible", "IE=edge"); // No more Compatibility Mode
            chain.doFilter(request, response);
        }
        } catch (Throwable t) {
