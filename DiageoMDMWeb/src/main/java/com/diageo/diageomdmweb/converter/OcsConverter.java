 ...
 * @author EDUARDO
 */
@FacesConverter(value = "ocsConverter")
public class OcsConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        return ocsBeanLocal.findById(id);
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if (value instanceof DbOcs) {
            DbOcs obj = (DbOcs) value;
            return obj.getOcsId() + "";
        }
        return "";
    }
