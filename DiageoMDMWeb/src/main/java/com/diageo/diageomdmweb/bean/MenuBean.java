...
public class MenuBean extends DiageoRootBean {
    ...
    public String navegar(String llave) {
        ...
        switch (moduloEnum) {
            ...
            case C_ADMIN:
                getLoginBean().armarMigaPan(capturarValor("m_administrador"), capturarValor("m_distribuidor"), capturarValor("m_distr_admin_create"));
                return "/admin/distribuidor/admin/createAdmin?faces-redirect=true";
            case S_ADMIN:
            ...
            case REPORT_SELLER:
                getLoginBean().armarMigaPan(capturarValor("m_report"), capturarValor("report_seller"));
                return "/reports/reportSeller?faces-redirect=true";
            case REPORT_DUPLICATES:
                getLoginBean().armarMigaPan(capturarValor("m_report"), capturarValor("report_duplicates"));
                return "/reports/reportDuplicates?faces-redirect=true";
        }
        return null;
    }   
