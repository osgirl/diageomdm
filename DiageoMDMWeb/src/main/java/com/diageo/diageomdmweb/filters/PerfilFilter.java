 ...
 */
package com.diageo.diageomdmweb.filters;
 ...
 * @author yovanoty126
 */
@WebFilter(filterName = "PerfilFilter", urlPatterns = {"/faces/perfil/*"})
public class PerfilFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("PerfilFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("PerfilFilter:DoAfterProcessing");
        }
        ...
        try {
            ...
            if (usu == null) {
                ...
                if (!contexto.contains("cambiarContrasenia.xhtml")) {
                    res.sendRedirect(req.getContextPath() + "/faces/perfil/cambiarContrasenia/cambiarContrasenia.xhtml");
                    return;
                }
            }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("PerfilFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("PerfilFilter(");
